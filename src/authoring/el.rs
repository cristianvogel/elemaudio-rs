...
fn node_props2(kind: &str, props: Value, a: impl Into<ElemNode>, b: impl Into<ElemNode>) -> Node {
...
/// Expects 3 children: cutoff, resonance/Q, and input signal.
pub fn lowpass(fc: impl Into<ElemNode>, q: impl Into<ElemNode>, x: impl Into<ElemNode>) -> Node {
    let fc = resolve(fc);
    let q = resolve(q);
    let x = resolve(x);
...
/// Expects 3 children: cutoff, resonance/Q, and input signal.
pub fn highpass(fc: impl Into<ElemNode>, q: impl Into<ElemNode>, x: impl Into<ElemNode>) -> Node {
    let fc = resolve(fc);
    let q = resolve(q);
    let x = resolve(x);
...
/// Expects 3 children: cutoff, resonance/Q, and input signal.
pub fn bandpass(fc: impl Into<ElemNode>, q: impl Into<ElemNode>, x: impl Into<ElemNode>) -> Node {
    let fc = resolve(fc);
    let q = resolve(q);
    let x = resolve(x);
...
/// Expects 3 children: cutoff, resonance/Q, and input signal.
pub fn allpass(fc: impl Into<ElemNode>, q: impl Into<ElemNode>, x: impl Into<ElemNode>) -> Node {
    let fc = resolve(fc);
    let q = resolve(q);
    let x = resolve(x);
